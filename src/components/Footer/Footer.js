    ...
    <div className="footer-container">
      ...
      <div class="footer-links">
        ...
        <div className="footer-link-wrapper">
          <div class="footer-link-items">
            <h2>Handles</h2>
            <a href="https://www.linkedin.com/in/vishnupriyagandi/">
              Ambassadors
            </a>
            <a href="https://www.linkedin.com/in/sasidhar-reddy-0b2446178/">
              Public Relations Manger
            </a>
            <a href="https://www.linkedin.com/in/gayathri-sadhineni/">
              Influencer
            </a>
          </div>
          <div class="footer-link-items">
      ...
      <section class="social-media">
        <div class="social-media-wrap">
          ...
          <small class="website-rights">Rentify © 2021</small>
